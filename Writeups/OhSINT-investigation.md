...
**Objective:** determine what can be uncovered about an individual starting from nothing but one image file, using only open-source/publicly available information.
